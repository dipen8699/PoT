...
def example_tool(query: str) -> str:
    ...
    # note the above docstring in the triple quotes is the description. Each tool MUST have a brief description about what kind of task this tool is perform and capable of.
